...
const Model = require("../models/AccountingType");
...
console.log(form);
const data = {
     AccountingTypeName:form.AccountingTypeName,
     AccountingTypeCode:form.AccountingTypeCode,
     AccountingTypeStatus:form.AccountingTypeStatus,
