...
const Model = require("../models/EducationalInstitutionDetail");
...
const data = {
     ...
     EducationalInstitutionDetailName:form.EducationalInstitutionDetailName,
     EducationalInstitutionTypeID:form.EducationalInstitutionTypeID,
